...
$timefrom = date("Y-m-d h:i:s", strtotime($daysfrom[$_POST['timefrom']]." -1 ".$_POST['timefrom'].' 00:00:00')) ;
$timeto = date("Y-m-d h:i:s", strtotime($daysto[$_POST['timefrom']].' This '.$_POST['timefrom'].' '.$_POST['timeto']));
